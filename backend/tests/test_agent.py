...
class TestToolRegistry:
    ...
    def test_register_tool_with_parameters(self):
        ...
        registry.register_tool("sample", sample_tool, "A sample tool", params)
...
class TestReactAgent:
    ...
    def test_execute_action(self):
        ...
        action = AgentAction(
            tool="sample", tool_input={"message": "hello"}, log="Testing sample tool"
        )
    ...
    def test_execute_nonexistent_tool(self):
        ...
        action = AgentAction(
            tool="nonexistent", tool_input={}, log="Testing nonexistent tool"
        )
    ...
    def test_execute_with_error(self):
        ...
        action = AgentAction(tool="error", tool_input={}, log="Testing error tool")
...
class TestModels:
    ...
    def test_agent_action_model(self):
        ...
        action = AgentAction(
            tool="test_tool", tool_input={"key": "value"}, log="test log"
        )
    ...
    def test_agent_finish_model(self):
        ...
        finish = AgentFinish(return_values={"result": "success"}, log="completed")
    ...
    def test_agent_step_model(self):
        ...
        action = AgentAction(tool="test_tool", tool_input={"key": "value"})
        step = AgentStep(action=action, observation="observed result")
